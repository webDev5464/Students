...
const dataRender = document.getElementById("dataRender")

//? map
dataRender.innerHTML = earbud.map((value) => {
  return `
    <div class="card">
      <div class="card-img">
...
// const data = ["Chagan", "Magan", "John", "Chintu"]
